...
<template>
  <div class="flex flex-col space-y-5">
    ...
    <!-- Status Indicator -->
    <div class="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 dark:bg-emerald-500/15 border border-emerald-500/20 w-fit">
      <CircleDot class="w-3.5 h-3.5 text-emerald-500 animate-pulse" />
